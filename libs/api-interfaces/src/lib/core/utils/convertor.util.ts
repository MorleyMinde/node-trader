...
export const convertMarketStateToArray = (state: OAndaMarketState) =>{
    ...
    array[3] = state.market.bids[0].liquidity;
    array[4] = state.market.asks[0].liquidity;
    array[5] = parseFloat(state.account.marginRate);
    array[6] = parseFloat(state.account.balance);
    ...
    array[14] = parseFloat(state.account.NAV);
    array[15] = parseFloat(state.account.marginUsed);
    array[16] = parseFloat(state.account.marginAvailable);
    array[17] = parseFloat(state.account.positionValue);
    array[18] = parseFloat(state.account.marginCloseoutUnrealizedPL);
    array[19] = parseFloat(state.account.marginCloseoutNAV);
    array[20] = parseFloat(state.account.marginCloseoutMarginUsed);
    array[21] = parseFloat(state.account.marginCloseoutPositionValue);
    array[22] = parseFloat(state.account.marginCloseoutPercent);
    array[23] = parseFloat(state.account.withdrawalLimit);
